...
import { CollectionType, ProductType } from "./productsColumn";
...
const ProductForm: React.FC<ProductFormProps> = ({ initialData }) => {
  ...
  // Simulate fetching collections with faker
  const collections = Array.from({ length: 5 }).map(() => ({
    _id: faker.string.uuid(),
    title: faker.commerce.productName(),
    description: faker.commerce.productDescription(),
    image: faker.image.url(),
    products: [], // Assuming an empty array for simplicity
  }));
  ...
  useEffect(() => {
    localStorage.setItem("media", JSON.stringify(form.watch("media")));
  }, [form.watch("media")]);
