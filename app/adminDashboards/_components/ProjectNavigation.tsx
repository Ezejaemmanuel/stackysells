    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <NavigationLink name="Progress">
          <ArrowTrendingUpIcon className="stroke-[0.75] stroke-inherit min-w-4 w-4" />
        </NavigationLink>
        <NavigationLink name="Team Members">
          <UserGroupIcon className="stroke-[0.75] stroke-inherit min-w-4 w-4" />
        </NavigationLink>
        <NavigationLink name="In Review">
          <PencilIcon className="stroke-[0.75] stroke-inherit min-w-4 w-4" />
        </NavigationLink>
        <NavigationLink name="In Progress">
          <BoltIcon className="stroke-[0.75] stroke-inherit min-w-4 w-4" />
        </NavigationLink>
        <NavigationLink name="Up Next">
          <CursorArrowRaysIcon className="stroke-[0.75] stroke-inherit min-w-4 w-4" />
        </NavigationLink>
        <NavigationLink name="Project Settings">
          <AdjustmentsHorizontalIcon className="stroke-[0.75] stroke-inherit min-w-4 w-4" />
        </NavigationLink>
      </div>
